  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">
       	<img src="http://localhost/conten/img/logo.png" style="width:120px; ">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="http://localhost/index.php/login/index">Inicio <span class="sr-only">(current)</span></a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="http://localhost/index.php/login/addfavorite#">Nuevo Favorito</a></li>
          </ul>
        </li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">           
            <li><a href="#">Acción1</a></li>
            <li><a href="#">Acción2</a></li>
            <li><a href="#">Algo más aquí</a></li>
            <li role="separator" class="divider"></li>
            <li><a href="http://localhost/index.php/login/close_session">Cerrar Sesión</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
